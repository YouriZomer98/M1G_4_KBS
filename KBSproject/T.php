...
<div class="container">
    <div id="products" class="row">
        ...
        if(isset($_GET['submit'])){
            $sql = "SELECT * FROM stockitems WHERE StockItemID IN (SELECT StockItemID FROM stockitemstockgroups WHERE StockGroupID = 4)";
        ...
        }else{$sql = "SELECT * FROM stockitems WHERE StockItemID IN (SELECT StockItemID FROM stockitemstockgroups WHERE StockGroupID = 4)";
        $product = dbSelectAll($sql);}
        $uniq = array();
        $k = 0;
