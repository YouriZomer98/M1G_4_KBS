...
<div class="sidenav">
    <form action="Items.php" method="get">
        ...
        <input type="checkbox" name="kleur[]" value="Light Brown"> <span style="color: tan;">&#11044;</span> Licht Bruin <br><br>
        <h3>Maat</h3>
        <input type="checkbox" name="maat[]" value="1/50 scale"> 1/50 Scale <br>
        <input type="checkbox" name="maat[]" value="1/12 scale"> 1/12 Scale <br>
        ...
        <input type="checkbox" name="maat[]" value="500g"> 500g <br>
        <br>
        <!--<p><input class="btn btn-info" type="submit" name="submit" value="Toepassen"></p>-->
    </form>
    <?php
